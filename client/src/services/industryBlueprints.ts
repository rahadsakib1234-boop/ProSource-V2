...
export const INDUSTRY_BLUEPRINTS: Record<string, IndustryBlueprint> = {
  ...
  professional_services: {
    dashboard: ['Active Projects', 'Billable Hours', 'Pending Invoices', 'Team Utilization'],
    crm: ['Clients', 'Projects', 'Meetings'],
    operations: ['Tasks', 'Meetings', 'Contracts', 'Time Tracking'],
    finance: ['Invoices', 'Retainers', 'Expenses', 'Collections'],
    reports: ['Project Profitability', 'Team Productivity', 'Client Value', 'Utilization Rate'],
    kpis: ['Billable Hours', 'Project Margin', 'Invoice Collection Rate', 'Team Utilization'],
    workflows: ['Lead → Proposal → Contract → Delivery → Invoice → Renewal'],
    actions: ['Create Proposal', 'Start Project', 'Log Hours', 'Send Invoice', 'Renew Contract'],
  },
  manufacturing: {
    dashboard: ['Production Output', 'Inventory Levels', 'Delayed Shipments', 'Defect Rate'],
    crm: ['Suppliers', 'Buyers', 'Vendors', 'Distributors'],
    operations: ['Production', 'Inventory', 'Warehouses', 'Procurement', 'Logistics', 'Quality Control'],
    finance: ['Purchase Orders', 'Production Costs', 'Freight Costs', 'Payments', 'Revenue'],
    reports: ['Production Efficiency', 'Defect Analysis', 'Shipment Performance', 'Inventory Forecast'],
    kpis: ['Production Output', 'Inventory Levels', 'Delayed Shipments', 'Defect Rate'],
    workflows: ['Procure → Produce → QC → Pack → Ship → Deliver'],
    actions: ['Create Production Order', 'Reorder Materials', 'Approve QC', 'Notify Shipment', 'Flag Defect'],
  },
  distribution: {
    dashboard: ['Production Output', 'Inventory Levels', 'Delayed Shipments', 'Defect Rate'],
    crm: ['Suppliers', 'Buyers', 'Vendors', 'Distributors'],
